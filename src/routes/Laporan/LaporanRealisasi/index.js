...
function createData(no, stasiun, progDAT, progBER, realisasiDAT, realisasiBER, deviasiDAT, deviasiBER, progVmax, progVop, realisasiVOP, progSF, realisasiSP, deviasiSF, keterangan) {
  return {no, stasiun, progDAT, progBER, realisasiDAT, realisasiBER, deviasiDAT, deviasiBER, progVmax, progVop, realisasiVOP, progSF, realisasiSP, deviasiSF, keterangan};
}

const rows = [
  createData('01', 'Surabaya Pasar Turi (SBI)', '-', '09:00:00', '-', '09:00:00', '-', '0', '110 Km/h', '80 Km/h', '(Mengambil dari locotrack, belum ditentukan data di titik mana yang diambil)', '4K1, 4K2, 1KM, 1KP', '5K1, 4K2, 1KM, 1KP', '+1K1, -1K2', '-'),
  createData('02', 'Surabaya Pasar Turi (SBI)', '-', '09:00:00', '-', '09:00:00', '-', '0', '110 Km/h', '80 Km/h', '(Mengambil dari locotrack, belum ditentukan data di titik mana yang diambil)', '4K1, 4K2, 1KM, 1KP', '5K1, 4K2, 1KM, 1KP', '+1K1, -1K2', '-'),
  createData('03', 'Surabaya Pasar Turi (SBI)', '-', '09:00:00', '-', '09:00:00', '-', '0', '110 Km/h', '80 Km/h', '(Mengambil dari locotrack, belum ditentukan data di titik mana yang diambil)', '4K1, 4K2, 1KM, 1KP', '5K1, 4K2, 1KM, 1KP', '+1K1, -1K2', '-'),
  createData('04', 'Surabaya Pasar Turi (SBI)', '-', '09:00:00', '-', '09:00:00', '-', '0', '110 Km/h', '80 Km/h', '(Mengambil dari locotrack, belum ditentukan data di titik mana yang diambil)', '4K1, 4K2, 1KM, 1KP', '5K1, 4K2, 1KM, 1KP', '+1K1, -1K2', '-'),
  createData('05', 'Surabaya Pasar Turi (SBI)', '-', '09:00:00', '-', '09:00:00', '-', '0', '110 Km/h', '80 Km/h', '(Mengambil dari locotrack, belum ditentukan data di titik mana yang diambil)', '4K1, 4K2, 1KM, 1KP', '5K1, 4K2, 1KM, 1KP', '+1K1, -1K2', '-'),
];
...
const breadcrumbs = [
  ...
  { label: 'Laporan Realisasi Perjalanan KA', isActive: true },
];
...
const LaporanRealisasi = () => {
  ...
  return (
    <PageContainer heading="Laporan" breadcrumbs={breadcrumbs}>
      <div className='header-container'>
        <div className='buttonHeader'>
        <Button variant="contained" color="success" startIcon={<DownloadIcon />}>Unduh Dokument</Button>
        <Button variant="contained" color="success" startIcon={<DownloadIcon />}>Unduh Locotrack</Button>
        </div>
        ...
        <Box sx={style}>
          ...
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            <div className='container-filter'>
              <div className='filter'>
                <div className='section-filter'>
                  <form>
                    <label>No KA</label>
                    <input placeholder='01' icon={<DownloadIcon />} style={{width:'210px'}}/>
                  </form>
                  <form>
                    <label>Tanggal</label>
                    <input placeholder='21 Desember 2022' icon={<DownloadIcon />} style={{width:'210px'}}/>
                  </form>
                </div>
                ...
                <div className='section-filter'>
                  <form>
                    <label>Nama KA</label>
                    <input placeholder='Argo Bromo' icon={<DownloadIcon />} style={{width:'210px'}}/>
                  </form>
                  <form>
                    <label>Relasi</label>
                    <input placeholder='-' icon={<DownloadIcon />} style={{width:'210px'}}/>
                  </form>
                </div>
                ...
                <div className='section-filter'>
                  <form>
                    <label>GAPEKA</label>
                    <input placeholder='2021' icon={<DownloadIcon />} style={{width:'210px'}}/>
                  </form>
                </div>
            ...
            <div className='button-modal'>
              <Button variant='outlined' color='success' className='buttonBatal'>Batal</Button>
          ...
          <div className='container-informasi'>
            ...
            <div className='section-informasi'>
                <div className='title-information'>
                  <span>KA 1 - Argo Bromo Anggrek</span>
                </div>
                <div className='title-information'>
                  <span>SBI - GMR</span>
                </div>
      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table" className='table'>
        <TableHead>
          <TableRow >
          <StyledTableCell style={{fontWeight : 'bold'}} rowSpan={2} align="center">No.</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} rowSpan={2} align="center">Stasiun</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} align="center" colSpan={2}>Program</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} align="center" colSpan={2}>Realisasi</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} align="center" colSpan={2}>Deviasi</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} align="center" colSpan={2}>Program</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} rowSpan={2} align="center">Realisasi Vop</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} rowSpan={2} align="center">Program SF</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} rowSpan={2} align="center">Realisasi SP</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} rowSpan={2} align="center">Deviasi SF</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} rowSpan={2} align="center">Keterangan</StyledTableCell>
          </TableRow>
          <TableRow>
            <StyledTableCell style={{fontWeight : 'bold'}} align="center">DAT</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} align="center">BER</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} align="center">DAT</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} align="center">BER</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} align="center">DAT</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} align="center">BER</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} align="center">Vmax</StyledTableCell>
            <StyledTableCell style={{fontWeight : 'bold'}} align="center">VOP</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
            <StyledTableRow key={row.name} >
              ...
              <StyledTableCell align="left">{row.stasiun}</StyledTableCell>
              <StyledTableCell align="left">{row.progDAT}</StyledTableCell>
              <StyledTableCell align="left">{row.progBER}</StyledTableCell>
              <StyledTableCell align="left">{row.realisasiDAT}</StyledTableCell>
              <StyledTableCell align="left">{row.realisasiBER}</StyledTableCell>
              <StyledTableCell align="left">{row.deviasiDAT}</StyledTableCell>
              <StyledTableCell align="left">{row.deviasiBER}</StyledTableCell>
              <StyledTableCell align="left">{row.progVmax}</StyledTableCell>
              <StyledTableCell align="left">{row.progVop}</StyledTableCell>
              <StyledTableCell align="left">{row.realisasiVOP}</StyledTableCell>
              <StyledTableCell align="left">{row.progSF}</StyledTableCell>
              <StyledTableCell align="left">{row.realisasiSP}</StyledTableCell>
              <StyledTableCell align="left">{row.deviasiSF}</StyledTableCell>
